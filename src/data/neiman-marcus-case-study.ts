  ...
  sections: [
    ...
    // ── META ──
    {
      ...
      summary: [
        ...
        { label: "Angle", value: "Make the website feel like a magazine, sell product like a store, don't let either side win. Saturated color did the work of a location scout." },
      ],
      abstract:
