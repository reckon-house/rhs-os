...
export const robertRodriguezCaseStudy: CaseStudy = {
  ...
  sections: [
    ...
    // ── META ──
    {
      ...
      type: "meta",
      title: "Robert Rodriguez x Neiman\u2019s",
      subtitle: "\u201980s mall glam meets high fashion. The double-exposure glamour shot reimagined: mesh gradients instead of airbrushed backdrops, couture instead of puff sleeves.",
      ...
      abstract: "The reference was the mall portrait studio. Soft-focus close-ups, oversaturated color, a little too much hairspray. We kept the energy and replaced everything else.\n\nFour studio shots, one model, custom compositing. Double-exposure layers stretched the shoot into a full campaign system. Mesh gradients gave the backgrounds pop-art softness without the dated airbrush look. Typography was built for this project — playful enough to match the concept, refined enough for the brand.",
    },
    ...
    },
    {
      ...
      size: "subhead",
      content:
        "Neiman Marcus needed a spring campaign for Robert Rodriguez that felt current without abandoning the brand's romantic sensibility. The budget was a single shoot day. The deliverable was a full multi-channel system — social, email, in-store, and editorial.",
      group: { name: "brief" },
    },
    {
      id: "brief-footnote",
      ...
      fullWidth: true,
      content:
        "The constraint became the concept. One model, four setups, and a compositing technique that turned four photographs into an entire visual language. Every piece of the campaign traces back to those four original frames — layered, blended, and recombined into something that feels like fifty shots instead of four.",
      group: { name: "brief" },
    },
    {
      id: "brief-columns",
    ...
    },
    {
      ...
      size: "subhead",
      content:
        "Each composite starts with two frames from the same session. A wide shot anchors the composition. A close-up bleeds across it — the face becoming a gradient, the gesture becoming a wash of color. The overlap isn't random. Every layer is placed to create depth where the original photograph is flat.",
    },
    {
      id: "process-footnote",
      type: "text",
      ...
      fullWidth: true,
      content:
        "The mesh gradient backdrops are generated to complement the clothing in each frame. Coral for the polka-dot dress. Pink for the yellow blazer. Orange for the seated portrait. The gradients don't just fill space — they extend the color story of the garment into the entire image. The background becomes part of the outfit.",
    },
    ...
    },
    {
      ...
      size: "subhead",
      content:
        "The compositing system meant every deliverable felt like its own photograph. Social crops pulled from the layered files differently than email headers. Retail signage used the gradients at full saturation. Editorial spreads let the double-exposure breathe across wide formats.",
    },
    {
      id: "deploy-footnote",
      type: "text",
      ...
      fullWidth: true,
      content:
        "The campaign ran across Neiman Marcus social channels, email marketing, and in-store retail displays. The storefront window installation used the composites at large format — the mesh gradients held up at scale because they were mathematically generated, not resolution-dependent. A three-foot print has the same color smoothness as a phone screen.",
    },
    ...
    },
    {
      ...
      size: "subhead",
      content:
        "A focused campaign that took the mall portrait studio reference seriously — the confidence, the color, the unironic glamour — and rebuilt it with contemporary craft.",
    },
    {
      id: "closing",
      type: "closing",
      ...
      content:
        "Four studio photographs became a complete campaign system through double-exposure compositing and mesh gradient backgrounds. The technique turned a single shoot day into a visual language that scaled across social, email, retail, and editorial — each format pulling differently from the same layered source files.\n\nThe typography, color palette, and compositing approach were designed as a unified system. Archer Hairline floats over saturated imagery. Mesh gradients extend the garment's color story into the background. Two frames become one image that contains more depth than either original.\n\nSocial, email, retail. One model, one concept, one day of shooting. The constraint was the brief. The brief became the work.",
    },
  ],
};
