/**
 * Inspiration board — manual list of saved images.
 *
 * V1 is just a flat array of image filenames. Add new ones by dropping the
 * file in /public/case-studies/inspiration/ and adding an entry below.
 *
 * Computer vision rename pass is pending — alt text and meaningful filenames
 * will land before this page goes live. Hash filenames are placeholders.
 *
 * When this list grows past ~150 items, migrate to Supabase + admin upload.
 */
