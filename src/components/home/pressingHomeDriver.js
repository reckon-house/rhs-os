...
function writeLedger(notesEl, a) {
  ...
  /* deduped: three projects are all titled "Hill Country home", and a
     ledger that says a name twice reads as a bug */
  const used = [...new Set(a.used || [])];
  /* The frame comes first: this feature is Jeremy trying AI in the
     open, and a visitor should read that before the mechanics. */
  ...
  wk.appendChild(row("Words", a.model || "claude"));
