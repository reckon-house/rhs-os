# Anthropic Economic Index: New Building Blocks for Understanding AI Use — Anthropic (Jan 15, 2026)

**Use for:** the canonical Anthropic reference. Research writing that earns credibility through methodology and data rather than swagger. The "science register" half of the art-meets-science synthesis Jeremy is building toward.

**Specific moves to study:**

- **Section headers as questions.** "Which tasks does AI speed up, and by how much?" / "What are the time horizons over which Claude can support tasks?" / "How does the nature of Claude's work vary across countries?" Each header is a real question the section answers. Different rhythm than the Pentagram claim-headlines, useful in a different register
- **Specific numerical data integrated naturally into prose, not as bullet points.** "Tasks with prompts requiring a high school education (12 years) were sped up by a factor of 9, while those requiring a college degree (16 years) were sped up by a factor of 12." The numbers are inside the sentence, working as evidence, not floating in a stat callout
- **Hedging done right.** "These results imply..." / "this might not be as discordant as it seems" / "we're not necessarily predicting that this deskilling will occur." Qualifies claims without becoming wishy-washy. Confidence is in the methodology, not in the certainty of the conclusion
- **Explicit acknowledgment of limitations.** "That said, even our revised assessment is still limited: we only assess tasks that are performed on Claude.ai, and it's not always clear how these conversations might map onto changes in the real world." This sentence is the move Anthropic does that most tech writing avoids. It's the opposite of overselling
- **Citations woven into prose, not stacked at the end.** Links to METR, O*NET, Microsoft research, and prior Anthropic reports all appear inline as part of the sentence they support
- **Long sentences that develop a complex idea step by step.** "On the graph below, we plot that earlier measure of occupations' task coverage along the x axis, and our new, adjusted measure on the y axis." The sentence does setup work; the next sentence does the punchline. Both are needed
- **Footnotes for definitions and clarifications.** Keeps the main text readable while preserving rigor. Footnote 2 unpacks all five primitives in detail without slowing the body
- **Restrained conclusions.** "Even a 1 percentage point increase in annual labor productivity growth would still be notable: it would return US productivity growth to the rates of the late 1990s and early 2000s." Doesn't oversell the headline number. Compares it to a real historical reference instead

**What NOT to copy:**

- **The institutional "we."** Anthropic writes as a research institution. Jeremy writes as a person. The "we" register works for them because it's accurate; it would feel inflated for a solo practice
- **Em dashes everywhere.** Anthropic uses em dashes throughout. Jeremy's voice has them banned in favor of hyphens-with-spaces ( - )
- **Heavy footnote use.** Useful here because the document is research with formal definitions to make. Probably overkill for Jeremy's case studies, where the same depth would slow the read
- **Some sentences run long even by Anthropic standards.** Borrow the cadence and willingness-to-develop-an-idea. Don't try to match the literal length

**When to reach for this:**

- Before writing or revising the **Sally Marketing OS** case study — that project has measurable outcomes and a methodology worth describing in this register
- Before writing any **House Staples article** that's arguing a thesis with data (the AI Leaderboard piece could have used more of this register's hedging in spots)
- Anywhere Jeremy needs to make a **measured claim about AI integration** in a project, especially when discussing what worked and what didn't
- Before drafting the **principles section** on the homepage — the Anthropic register is the right one for explaining the reasoning behind a practice without performing it

**Pair this reference with:** `pentagram.md` for the Pentagram claim-headlines that work in a different register. Anthropic's question-headlines and Pentagram's claim-headlines are both useful but for different kinds of pieces — Anthropic for analysis and methodology, Pentagram for project storytelling.

**Note:** the original page includes data visualizations (scatterplots, bar charts) that didn't carry through in the text capture. The visual register of the page reinforces the prose — restrained typography, charts as actual evidence rather than decoration. Worth viewing the live URL once for visual reference: https://www.anthropic.com/research/economic-index-primitives

---

# Anthropic Economic Index: New building blocks for understanding AI use

*Economic Research, January 15, 2026*
...
You can read the fourth Economic Index report. Below, we summarize its results.
...
A further question we asked is whether the tasks that AI covers represent the higher- or the lower-skilled components of a given occupation. Using an estimate that we create of the skill level required for each task, we find that Claude is relatively more likely to cover the tasks that require *higher* education levels—specifically, tasks that require an average of 14.4 years of education (equivalent to a US associate's degree), relative to the economy's average of 13.2. This aligns with our earlier finding that Claude is used more frequently by white-collar workers.
...
*Source: Anthropic, "Anthropic Economic Index: New building blocks for understanding AI use," January 15, 2026. Stored here for personal voice study reference.*
