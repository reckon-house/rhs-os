...
<style>
  ...
  .ccol .crow .cmk { display: block; height: var(--mh, 15px); width: auto;
    max-width: 100%; border-radius: 0; background: none;
...
/* the live footer's per-mark heights, verbatim from PressingCredits.tsx:
   equal height is not equal optical weight, and these were tuned
   against these exact files. 15 is the default there and here. */
const MARK_H = { "Nordstrom": 12, "Rejuvenation": 13, "Visual Comfort": 11,
  "Floor & Decor": 14, "Design Within Reach": 17 };
